                ...
                <div class="filter-block pull-right">
                    <div class="form-group pull-left list-search-block">
                        <form id="search-form" method="GET">
                            <div class="pull-left text-label"><label for="c">@lang('website.city')：</label></div>
                            <div class="pull-left">
                    ...
                    <table id="list-table" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>@lang('website.belong_station')</th>
                                <th>@lang('website.gps_area')</th>
                        ...
                        <tbody>
                            @if (count($aInfo) > 0)
                                ...
                                <tr class="tr-{{$aVal['_id']}}">
                                    ...
                                    <td class="belong_station text-center">{{$aVal['belong_station']}}</td>
                                    <td class="belong_area text-center">{{$aVal['belong_area']}}</td>
                                    <td class="text-center">
                                        ...
                                        <div class="hidden del_message">
                                            <br />
                                            @lang('website.city')：<span class="del_city">@lang('website.city_'.$aVal['city'])</span><br />
                                            @lang('website.belong_station')：<span class="del_belong_station">{{$aVal['belong_station']}}</span><br />
                                            @lang('website.gps_area')：<span class="del_belong_area">{{$aVal['belong_area']}}</span>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="belong_station"><span class="text-danger">*</span>@lang('website.belong_station')</label>
                    <input type="text" class="form-control" id="belong_station" name="belong_station" maxlength="20" size="20">
                </div>
                <div class="form-group">
                    <label for="belong_area"><span class="text-danger">*</span>@lang('website.gps_area')</label>
                    <input type="text" class="form-control" id="belong_area" name="belong_area" maxlength="20" size="20">
                </div>
            </div>
...
var aColumn = ['city', 'belong_station', 'belong_area'], aError = ['@lang('error.city_name_empty')', '@lang('error.belong_station_empty')', '@lang('error.belong_area_empty')'];
var default_city = '{{$aGet['c']}}';
</script>
<script src="{{ asset('js/Gps/Area.js') }}"></script>
@endsection