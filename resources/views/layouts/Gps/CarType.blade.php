                ...
                <div class="filter-block pull-right">
                    <div class="form-group pull-left list-search-block">
                        <form id="search-form" method="GET">
                            ...
                            <div class="pull-left">
                                <input type="text" id="type" name="type" class="form-control" value="{{$aGet['type']}}" maxlength="20" size="20">
                            </div>
                    ...
                    <table id="list-table" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th width="60%">@lang('website.car_type')</th>
                        ...
                        <tbody>
                                ...
                                <tr class="tr-{{$aVal['_id']}}">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="hidden del_message">
                                            <br />
                                            @lang('website.car_type')：<span id="del_car_type">{{$aVal['car_type']}}</span><br />
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
                            @else
                            <tr>
                                <td colspan="3" class="text-center">@lang('website.no_data')</td>
                            </tr>
                            @endif
                        </tbody>
                    </table>
