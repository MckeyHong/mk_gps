                ...
                <div class="filter-block pull-right">
                    <div class="form-group pull-left list-search-block">
                        <form id="search-form" method="GET">
                            ...
                            <div class="pull-left">
                                <input type="text" id="shift" name="shift" class="form-control" value="{{$aGet['shift']}}" maxlength="10" size="10">
                            </div>
                    ...
                    <table id="list-table" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>@lang('website.shift_start')</th>
                                <th>@lang('website.shift_end')</th>
                        ...
                        <tbody>
                            @if (count($aInfo) > 0)
                                ...
                                <tr class="tr-{{$aVal['_id']}}">
                                    ...
                                    <td class="shift_name text-center">{{$aVal['shift_name']}}</td>
                                    <td class="shift_start_time text-center">{{$aVal['shift_start_time']}}</td>
                                    <td class="shift_end_time text-center">{{$aVal['shift_end_time']}}</td>
                                    <td class="text-center">
                                        ...
                                        <div class="hidden del_message">
                                            <br />
                                            @lang('website.staff_shift')：{{$aVal['shift_name']}}<br />
                                            @lang('website.shift_start')：{{$aVal['shift_start_time']}}<br />
                                            @lang('website.shift_end')：{{$aVal['shift_end_time']}}
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="shift_name"><span class="text-danger">*</span>@lang('website.staff_shift')</label>
                    <input type="text" class="form-control" id="shift_name" name="shift_name" maxlength="10" size="10">
                </div>
               <div class="form-group">
                    <label for="shift_start_time"><span class="text-danger">*</span>@lang('website.shift_start')</label>
                    <input type="text" class="form-control" id="shift_start_time" name="shift_start_time" maxlength="10" size="10">
                </div>
               <div class="form-group">
                    <label for="shift_end_time"><span class="text-danger">*</span>@lang('website.shift_end')</label>
                    <input type="text" class="form-control" id="shift_end_time" name="shift_end_time" maxlength="10" size="10">
                </div>
            </div>
...
@section('js_self')
<script>
var del_msg_multi = '@lang('website.js_del_msg_multi')', del_msg = '@lang('website.js_del_msg')', error_del = '@lang('error.select_del_empty')', title_add = '@lang('website.detail_add')', title_edit = '@lang('website.detail_edit')', error_type = '@lang('error.car_type_empty')';
var aColumn = ['shift_name', 'shift_start_time', 'shift_end_time'], aError = ['@lang('error.shift_name_empty')', '@lang('error.shift_start_empty')', '@lang('error.shift_end_empty')'];
</script>
<script src="{{ asset('js/Work/ShiftSet.js') }}"></script>
@endsection