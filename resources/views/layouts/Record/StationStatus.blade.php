                    ...
                    <table id="list-table" class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th>@lang('website.empty_rope')</th>
                                <th>@lang('website.bike_empty')</th>
                                <th>@lang('website.normal_rope')</th>
                                <th>@lang('website.bike_full')</th>
                                <th>@lang('website.empty_rope_time')</th>
                                <th>@lang('website.bike_empty_time')</th>
                                <th>@lang('website.normal_rope_time')</th>
                                <th>@lang('website.bike_full_time')</th>
                                <th>@lang('website.acc_empty_time')</th>
                                <th>@lang('website.acc_full_time')</th>
                            </tr>
                        </thead>
                        <tbody>
                            @if (count($aInfo) > 0)
