...
use App\Services\Gps\CarService as Service;

class Car extends Controller
{
    protected $oServices;
    private $sListPath = '/Gps/Car';
    ...
    public function index(Request $request)
    {
        ...
        return view($this->layouts,[
            ...
            'aGet'      => $aInfo['get'],
            'aCity'     => $aInfo['city'],
            'aCarBrand' => $aInfo['car_brand'],
            'aCarType'  => $aInfo['car_type'],
            'aGPS'      => $aInfo['gps']
        ]);
    }
    ...
    {
        return response()->json($this->oServices->delete($id, array_merge(
            $request->all(),
            ['default_url' => $request->root().$this->sListPath]
        )));
    }
