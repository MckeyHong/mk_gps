...
class UpdateStation extends Job implements SelfHandling, ShouldQueue
{
    ...
    {
        $this->oStation = new StationRepository;
        $this->oTaipei = new TaipeiRepository;
        $this->oTaichung = new TaichungRepository;
