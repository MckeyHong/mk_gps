/*global jQuery, now_url, func_url, error_type, title_add, title_edit, error_del, del_msg, del_msg_multi*/
...
jQuery(document).ready(function ($) {
    ...
    var updateInfo = function () {
        $('#list-table').find('.tr-' + $('#data-form #id').val()).find('.car_type').html($('#data-form #car_type').val());
        $('#del_car_type').html($('#data-form #car_type').val());
    ...
    $('.btn-edit').click(function () {
        ...
        $('#data-form #car_type').val(oTr.find('.car_type').html());
        $('#DetailModal').modal();
    });
